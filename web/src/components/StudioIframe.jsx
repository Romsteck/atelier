    ...
    return (
      <div className="flex items-center justify-center h-full bg-gray-900">
        <div className="max-w-sm w-full mx-4 p-6 rounded-lg bg-gray-800 border border-gray-700 shadow-xl text-center">
          ...
          <h3 className="text-base font-semibold text-gray-50 mb-1">CloudMaster est éteint</h3>
        ...
        <div className="max-w-sm w-full mx-4 p-6 rounded-lg bg-gray-800 border border-gray-700 shadow-xl text-center">
          {wakeTimedOut ? (
            <>
              ...
              <h3 className="text-base font-semibold text-gray-50 mb-1">Démarrage prolongé</h3>
              <p className="text-sm text-gray-400 mb-4">
            ...
            <>
              ...
              <h3 className="text-base font-semibold text-gray-50 mb-1">Boot en cours…</h3>
