...
Pour CHAQUE faille réelle, appelle `findings_upsert` :

- `kind = "security"`, `category` (une des catégories ci-dessus), `severity`, `fingerprint` (hash stable, ex. `fichier:type-de-faille`), `evidence` (`{ "file_path": "...", "lines": "..." }`).
- `title` : résumé ≤120 chars.
- `summary` : la **présentation** de l'issue (2-4 phrases) — quoi, où (fichier:ligne), vecteur d'exploitation, impact. C'est ce qui s'affiche dans la liste des issues.
...
findings_upsert(
  ...
  title = "résumé ≤120 chars",
  summary = "présentation courte de la faille",
  plan = "## Contexte\n...\n## Cause racine\n...\n## Fichiers impactés\n...\n## Étapes de correction\n...\n## Validation\n...",
