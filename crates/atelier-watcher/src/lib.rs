...
pub use service::{
    AppMeta, AuthFailureSink, BacklogSettledSink, ERR_SCAN_ALREADY_RUNNING, RunOutcome, ScanCell,
    SurveillanceConfig, SurveillanceService, SweepAppRow, SweepScanState, SweepSnapshot,
    SweepStatus, TokenProvider,
};
