...
// Exceptions assumées : `notify_user` et `issue_report` (communication vers l'utilisateur /
// remontée plateforme, écrivent dans la méta-DB seulement — jamais dans l'app) et
// `env_list` (lecture, secrets masqués serveur).
